...
async function processDevices(devices, maintainers) {
  return Promise.all(devices.map(async device => {
    ...
    return {
      ...
      image_url: images.banner || 'img/fallback.webp',
      image_url_lower: images.banner_lower || images.banner || 'img/fallback.webp',
      original_image_url: images.fallback || 'img/fallback.webp',
        ...
        <div class="device-header">
          ...
          <div class="device-info">
            ...
            <a href="${safeMaintainerGithub}" target="_blank" rel="noopener noreferrer" class="maintainer-info">
              <img src="${safeMaintainerAvatar}" alt="${safeMaintainer}" class="maintainer-avatar" onerror="this.src='img/fallback.webp';" />
        ...
        <div class="device-info-card">
          ...
          <div class="device-maintainer-card">
            <a href="${safeMaintainerGithub}" target="_blank" rel="noopener noreferrer" class="maintainer-link">
              <img src="${safeMaintainerAvatar}" alt="${safeMaintainer}" class="maintainer-modal-avatar" onerror="this.src='img/fallback.webp';" />
